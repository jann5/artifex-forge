    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <Dialog open={isImageModalOpen} onOpenChange={setIsImageModalOpen}>
        <DialogContent 
          ...
          className="!max-w-none !w-screen !h-screen !p-0 !m-0 !rounded-none !border-none bg-black/95 !translate-x-0 !translate-y-0 !top-0 !left-0 flex items-center justify-center overflow-hidden"
        >
          <button
