...
export default function OrdersPage() {
  ...
  const customOrders = useQuery(api.customOrders.listWithMessages);
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        >
          ...
          {customOrders && customOrders.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">Zamówienia Niestandardowe</h2>
          ...
          <h2 className="text-2xl font-bold mb-4">Standardowe Zamówienia</h2>
          <div className="space-y-4">
            {orders === undefined ? (
              <div className="space-y-4">
